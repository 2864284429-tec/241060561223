...
| Features | nvarchar(200) | NULL | NULL | 设备信息（如：有电源、有台灯） |
...
| 页面 | 查询条件 | 返回字段 | SQL 示例 |
|------|----------|----------|----------|
| 座位列表 | 无 | Id, Name, Location, Features, IsAvailable | `SELECT * FROM Seats WHERE IsAvailable = 1` |
...
using (var scope = app.Services.CreateScope())
{
    ...
    if (!dbContext.Seats.Any())
    {
        dbContext.Seats.AddRange(
            new Seat { Name = "A-01", Location = "一楼靠窗", Capacity = 1, Features = "有电源", IsAvailable = true },
            new Seat { Name = "A-02", Location = "一楼靠窗", Capacity = 1, Features = "有电源", IsAvailable = true },
            new Seat { Name = "A-03", Location = "一楼靠窗", Capacity = 1, Features = "有台灯", IsAvailable = true },
            new Seat { Name = "B-01", Location = "二楼安静区", Capacity = 1, Features = "有电源", IsAvailable = true },
            new Seat { Name = "B-02", Location = "二楼安静区", Capacity = 1, Features = NULL, IsAvailable = true },
            new Seat { Name = "B-03", Location = "二楼安静区", Capacity = 1, Features = "有电源", IsAvailable = true },
            new Seat { Name = "C-01", Location = "三楼讨论区", Capacity = 4, Features = "有电源、有白板", IsAvailable = true },
            new Seat { Name = "C-02", Location = "三楼讨论区", Capacity = 4, Features = "有电源", IsAvailable = true }
        );
...
INSERT INTO Seats (Name, Location, Capacity, Features, IsAvailable) VALUES
